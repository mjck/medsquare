...
BIOIMAGESUITE_DIR=/usr/local/bioimagesuite30/lib; export BIOIMAGESUITE_DIR
BIOIMAGESUITE_VTK_DIR=/usr/local/bioimagesuite3_base64/vtk510/lib/vtk-5.10; export BIOIMAGESUITE_VTK_DIR
BIOIMAGESUITE_GDCM_DIR=/usr/local/bioimagesuite3_base64/gdcm20/lib; export BIOIMAGESUITE_GDCM_DIR
...
LD_LIBRARY_PATH=${BIOIMAGESUITE_DIR}:${LD_LIBRARY_PATH}
LD_LIBRARY_PATH=${BIOIMAGESUITE_VTK_DIR}:${LD_LIBRARY_PATH}
LD_LIBRARY_PATH=${BIOIMAGESUITE_GDCM_DIR}:${LD_LIBRARY_PATH}
...
DYLD_LIBRARY_PATH=${BIOIMAGESUITE_DIR}:${DYLD_LIBRARY_PATH}
DYLD_LIBRARY_PATH=${BIOIMAGESUITE_VTK_DIR}:${DYLD_LIBRARY_PATH}
DYLD_LIBRARY_PATH=${BIOIMAGESUITE_GDCM_DIR}:${DYLD_LIBRARY_PATH}
...
echo "BIOIMAGESUITE in ${BIOIMAGESUITE_DIR}"
