...
// vtkDICOMImageReader
#ifndef __vtkmsqGDCMMoisacImageReader_h
#define __vtkmsqGDCMMoisacImageReader_h
...
public:
  ...
  //virtual void SetMedicalImageProperties(vtkmsqMedicalImageProperties *pd);
...
//BTX
  bool ComputeMOSAICDimensions(gdcm::File &file, unsigned int dims[3]);
...
private:
  vtkmsqGDCMMoisacImageReader(const vtkmsqGDCMMoisacImageReader&); // Not implemented.
  void operator=(const vtkmsqGDCMMoisacImageReader&); // Not implemented.
};
#endif
